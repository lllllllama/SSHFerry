...
const messages: Record<AppLanguage, Record<string, MessageValue>> = {
  zh: {
    ...
    'auth.captchaLoadFailed': '\u9a8c\u8bc1\u7801\u52a0\u8f7d\u5931\u8d25\uff0c\u8bf7\u70b9\u51fb\u9a8c\u8bc1\u7801\u56fe\u7247\u91cd\u8bd5',
    'socket.idle': '\u7a7a\u95f2',
    ...
    'workspace.toast.sessionCloseFailed': '\u5173\u95ed\u4f1a\u8bdd\u5931\u8d25',
    ...
    'siteSidebar.toast.checkFailed': ({ siteName }) => `\u8fde\u63a5\u68c0\u6d4b\u5931\u8d25\uff1a${siteName}`,
    ...
    'siteSidebar.toast.sessionOpenFailed': '\u6253\u5f00\u4f1a\u8bdd\u5931\u8d25',
    'siteSidebar.toast.sessionClosed': 'Remote session closed',
    'siteSidebar.toast.sessionCloseFailed': '\u5173\u95ed\u4f1a\u8bdd\u5931\u8d25',
    ...
    'siteEditor.toast.saveFailed': '\u4fdd\u5b58\u7ad9\u70b9\u5931\u8d25',
    ...
    'taskCenter.toast.actionFailed': ({ action }) => `${action} \u8bf7\u6c42\u5931\u8d25`,
    'taskCenter.toast.clearedFinished': '\u5df2\u6e05\u7406\u5b8c\u6210\u4efb\u52a1',
    'taskCenter.toast.clearFailed': '\u6e05\u7406\u5df2\u5b8c\u6210\u4efb\u52a1\u5931\u8d25',
    ...
    'remotePane.createDirectoryFailed': '\u8fdc\u7aef\u76ee\u5f55\u521b\u5efa\u5931\u8d25',
    ...
    'remotePane.renameFailed': '\u8fdc\u7aef\u91cd\u547d\u540d\u5931\u8d25',
  ...
  en: {
    ...
    'auth.captchaLoadFailed': 'Failed to load the captcha. Click the captcha image to retry.',
    'socket.idle': 'Idle',
    ...
    'workspace.toast.noRemoteCopySelection': 'No remote selection available for copy',
    'workspace.toast.sessionClosed': 'Remote session closed',
    'workspace.toast.sessionCloseFailed': 'Failed to close session',
    ...
    'siteSidebar.toast.checkComplete': ({ siteName }) => `Connection check completed: ${siteName}`,
    'siteSidebar.toast.checkFailed': ({ siteName }) => `Connection check failed: ${siteName}`,
    'siteSidebar.toast.sessionOpened': 'Remote session opened',
    'siteSidebar.toast.sessionOpenedMessage': ({ siteName, sessionId }) => `${siteName} / ${sessionId}`,
    'siteSidebar.toast.sessionOpenFailed': 'Failed to open session',
    'siteSidebar.toast.sessionClosed': 'Remote session closed',
    'siteSidebar.toast.sessionCloseFailed': 'Failed to close session',
    'siteSidebar.toast.siteDeleted': ({ siteName }) => `Site ${siteName} deleted`,
    ...
    'siteEditor.toast.saveFailed': 'Failed to save site',
    ...
    'taskCenter.toast.actionFailed': ({ action }) => `${action} request failed`,
    'taskCenter.toast.clearedFinished': 'Finished tasks cleared',
    'taskCenter.toast.clearFailed': 'Failed to clear finished tasks',
    ...
    'log.clearFailed': 'Failed to clear logs',
    ...
    'remotePane.createDirectoryFailed': 'Failed to create remote directory',
    ...
    'remotePane.renameFailed': 'Failed to rename remote path',
